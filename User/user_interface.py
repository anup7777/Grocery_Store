...
class Customer_interface:
    ...
    def __init__(self, customerloggedin, customerloggedinname):
        ...
        # Major Heading
        self.lb_heading_inital = Label(self.wn, text="Customer", bg="pink",
                                       font=('Impact', 34, 'bold', 'underline'), fg='red')
        self.lb_heading_inital.place(x=50, y=120)
        self.lb_heading_end = Label(self.wn, text="Panel", bg="pink", font=('Impact', 34, 'bold', 'underline'),
                                    fg='blue')
        self.lb_heading_end.place(x=250, y=120)
        ...
        self.credentials = Button(self.wn, image=self.credentials_button, bd=0, bg='pink', fg="white",
                                          ...
                                          command=self.change_customer_credentials, width=230, relief=RIDGE,
                                          overrelief=RAISED)
        self.credentials.image = self.credentials_button
        self.credentials.place(x=70, y=230)

        self.cartbutton = PhotoImage(file="C:\\store\\viewitembtn.png")
        self.cart = Button(self.wn, image=self.cartbutton, bd=0, bg='pink', fg="white",
                                  activebackground="#73C2FB", activeforeground="indigo",
                                  font=("Comic Sans MS", 14, "bold"), height=50, cursor="hand2",
                                  command=self.show_items, width=230, relief=RIDGE,
                                  overrelief=RAISED)
        self.cart.image = self.cartbutton
        self.cart.place(x=70, y=350)
    ...
    def change_customer_credentials(self):
        ...
        self.changeboard_btn1 = Button(self.navigation_frame, image=self.changeboard_btn1_img,
                                       ...
                                       bg="white", fg="black", font=("arial", 15), bd=0, height=30, width=100)
